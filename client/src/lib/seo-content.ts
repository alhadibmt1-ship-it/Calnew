...
const contentTemplates: Record<string, SEOContentSection> = {
  ...
  "birth-chart-calculator": {
    whatIs: "A Birth Chart Calculator (also called a natal chart) maps the exact positions of the Sun, Moon, and all eight planets at the precise moment and location of your birth. This cosmic snapshot is the foundation of Western astrology — it describes your personality, emotional patterns, relationship style, career aptitudes, and life themes.",
    whatIsExtra: [
      "Your birth chart is divided into 12 houses, each governing a different area of life — from identity and money to relationships, career, and spirituality. Each planet falls into a zodiac sign and a house, creating a unique combination that astrologers interpret to understand your strengths, challenges, and purpose.",
      "Unlike a sun sign horoscope that only uses your birthday, a full birth chart requires your exact birth time and birthplace. Even a difference of four minutes changes your rising sign (Ascendant) and shifts the house positions of all planets. This is why your birth certificate time matters so much in natal astrology.",
    ],
    howFormulaWorks: "Planetary positions are calculated using mean orbital elements and epoch offsets from J2000.0 (January 1, 2000 at 12:00 TT). House cusps use the Placidus system, which divides the ecliptic into 12 unequal houses based on the local sidereal time at birth.",
    formulaBreakdown: [
      "Julian Day Number (JDN) = days elapsed since January 1, 4713 BC at noon",
      "T = (JDN − 2451545.0) / 36525 — centuries from J2000.0",
      "Each planet's longitude = mean longitude + corrections for eccentricity and inclination",
      "Ascendant = point of the ecliptic rising above the eastern horizon at the birth time and place",
      "Houses 1–12 = derived from the Ascendant using the Placidus division algorithm",
    ],
    howToUse: [
      "Enter your date of birth (day, month, year)",
      "Enter your exact time of birth — check your birth certificate for accuracy",
      "Enter your birth city or location",
      "Click Calculate to generate your full birth chart",
      "Review each planet's sign and house placement, and the SVG natal wheel",
    ],
    exampleTitle: "Example: Person born March 21, 1990 at 14:30 in London",
    exampleContent: "Sun in Aries (House 10) — public identity and career ambition. Moon in Scorpio (House 5) — deep emotional intensity in creative expression. Rising sign Gemini — curious, communicative outward personality. Venus in Pisces — romantic, empathetic love style.",
    tables: [
      {
        title: "The 12 Astrological Houses and Their Meanings",
        headers: ["House", "Area of Life", "Key Themes"],
        rows: [
          ["1st — Ascendant", "Self & Identity", "Appearance, first impressions, personality"],
          ["2nd", "Money & Values", "Income, possessions, self-worth"],
          ["3rd", "Communication", "Siblings, short travel, writing, thinking"],
          ["4th — IC", "Home & Roots", "Family, ancestry, private life"],
          ["5th", "Creativity & Romance", "Children, hobbies, love affairs, play"],
          ["6th", "Work & Health", "Daily routine, service, wellness"],
          ["7th — Descendant", "Partnerships", "Marriage, open enemies, contracts"],
          ["8th", "Transformation", "Death, rebirth, shared resources, sexuality"],
          ["9th", "Philosophy", "Higher education, travel, beliefs, law"],
          ["10th — Midheaven", "Career & Status", "Public reputation, authority, ambitions"],
    ...
    tips: [
      "Get your exact birth time from your birth certificate for the most accurate chart",
      "If your birth time is unknown, use noon as a default — but house placements won't be reliable",
      "Read your chart holistically — no single planet defines you; the whole chart tells the story",
      "Planetary aspects (angles between planets) are just as important as sign placements",
    ],
    limitations: [
      "Requires an accurate birth time — even a few minutes can change the rising sign",
      "Positions are calculated using mean orbital elements, giving approximate rather than exact positions",
      "Does not include minor asteroids, Chiron, or outer dwarf planets in the default calculation",
      "Astrology is not a science — interpretations are symbolic and psychological, not predictive",
    ],
  },

  "rising-sign-calculator": {
    whatIs: "Your Rising Sign (also called the Ascendant) is the zodiac sign that was coming up over the eastern horizon at the exact moment you were born. It is one of the three most important placements in astrology — alongside your Sun sign and Moon sign — and describes how you present yourself to the world, your physical appearance, and the first impression you make on others.",
    whatIsExtra: [
      "While your Sun sign represents your core identity and your Moon sign governs your inner emotional world, your Rising sign acts as your social mask or persona. It's the energy people notice before they get to know you well. Two people with the same Sun sign can have very different rising signs — which is why people sometimes don't 'feel' like their horoscope sign.",
      "The Ascendant changes signs approximately every two hours as the Earth rotates, which is why your exact birth time is essential for calculating it correctly. This also makes the Rising sign one of the most personal and precise points in a birth chart.",
    ],
    howFormulaWorks: "The Rising sign is calculated using the Local Sidereal Time (LST) at the birth moment. LST is derived from Greenwich Sidereal Time adjusted for the birthplace's geographic longitude. The Ascendant degree is then found where the ecliptic intersects the eastern horizon.",
    formulaBreakdown: [
      "GST = Greenwich Mean Sidereal Time at 0h UT + (UT hours × 1.00273791)",
      "LST = GST + (longitude in hours, where 1 hour = 15 degrees east)",
      "Obliquity of ecliptic ε ≈ 23.4393° − 0.0130° × T (T = centuries from J2000)",
      "RAMC (Right Ascension of Midheaven) = LST × 15",
      "Ascendant = arctan(−cos(RAMC) / (sin(RAMC) × cos(ε) + tan(latitude) × sin(ε)))",
    ],
    howToUse: [
      "Enter your birth date",
      "Enter your exact birth time (from your birth certificate)",
      "Enter your birth city or town",
      "Click Calculate to see your Rising sign with its traits and themes",
    ],
    exampleTitle: "Example: Born on June 15, 1995 at 7:00 AM in New York",
    exampleContent: "With a 7 AM birth in New York in mid-June, Cancer would be rising on the eastern horizon → Cancer Rising: nurturing outward manner, sensitive first impression, protective energy, strong home focus.",
    tables: [
      {
        title: "Rising Sign Traits at a Glance",
        headers: ["Rising Sign", "First Impression", "Physical Traits"],
        rows: [
          ["Aries Rising", "Bold, energetic, direct", "Athletic build, quick movements"],
          ["Taurus Rising", "Calm, grounded, sensual", "Sturdy build, melodious voice"],
          ["Gemini Rising", "Curious, witty, restless", "Bright eyes, expressive hands"],
          ["Cancer Rising", "Nurturing, shy, protective", "Round face, empathetic gaze"],
          ["Leo Rising", "Confident, warm, dramatic", "Regal posture, striking hair"],
          ["Virgo Rising", "Precise, analytical, modest", "Neat appearance, observant"],
          ["Libra Rising", "Charming, diplomatic, aesthetic", "Balanced features, graceful"],
          ["Scorpio Rising", "Intense, magnetic, mysterious", "Penetrating eyes, powerful presence"],
          ["Sagittarius Rising", "Optimistic, adventurous, blunt", "Tall, athletic, broad smile"],
          ["Capricorn Rising", "Reserved, ambitious, serious", "Strong jaw, composed bearing"],
          ["Aquarius Rising", "Quirky, detached, intellectual", "Unique style, aloof manner"],
          ["Pisces Rising", "Dreamy, empathetic, fluid", "Soft eyes, ethereal quality"],
        ],
      },
    ],
    tips: [
      "Your Rising sign is only as accurate as your birth time — aim for the exact minute if possible",
      "Read your Rising sign's horoscope alongside your Sun sign for a more complete picture",
      "The ruler of your Rising sign (its ruling planet) is especially important in your chart",
      "Your Rising sign also determines the starting house in your chart, setting the stage for all other placements",
    ],
    limitations: [
      "Requires your exact birth time — an error of two hours can shift the Rising sign entirely",
      "Calculated using mean orbital elements, giving an approximation rather than a precise astronomical position",
      "Rising sign traits describe tendencies, not fixed personality — other chart factors modify the expression",
    ],
  },

  "synastry-calculator": {
    whatIs: "A Synastry Calculator compares two people's birth charts to analyse romantic and interpersonal compatibility. Synastry is the branch of astrology concerned with how two people's planetary energies interact — which connections create harmony, attraction, and understanding, and which create friction, challenge, or intensity.",
    whatIsExtra: [
      "In synastry, the planets of one person's chart are overlaid onto the other's. When one person's Venus aligns with another's Mars, it often creates strong romantic attraction. When Saturn from one chart falls on the other's Moon, it may indicate a serious, stabilising but potentially restricting bond. These interplanetary contacts tell the story of the relationship.",
      "Synastry is widely used in relationship counselling, self-awareness, and understanding why some connections feel fated while others require conscious effort. It does not predict relationship success or failure — instead, it illuminates the dynamics at play and the growth opportunities in the connection.",
    ],
    howFormulaWorks: "Each person's planetary positions are calculated individually using mean orbital elements. The synastry score is derived by measuring the angular distance (aspect) between each pair of planets and applying a weighted scoring system based on aspect type (conjunction, trine, square, opposition, sextile) and planetary importance.",
    formulaBreakdown: [
      "Conjunction (0°) — planets merge energy, very strong, can be positive or challenging",
      "Trine (120°) — harmonious flow, natural ease and compatibility",
      "Sextile (60°) — supportive, cooperative energy requiring some effort",
      "Square (90°) — tension and friction that drives growth and action",
      "Opposition (180°) — polarity and attraction, can complement or conflict",
      "Orb = allowed deviation from exact aspect (usually ±8° for major aspects)",
    ],
    howToUse: [
      "Enter Person 1's date of birth",
      "Enter Person 2's date of birth",
      "Click Calculate to run the synastry comparison",
      "Review the planet comparison table and four compatibility score bars",
      "Read the written aspect interpretations for the most significant planetary connections",
    ],
    exampleTitle: "Example: Comparing Aries Sun person with Libra Sun person",
    exampleContent: "Sun-Sun Opposition (Aries ↔ Libra): Classic complementary opposition — Aries brings boldness and initiative; Libra brings diplomacy and balance. High romantic tension, mutual fascination, and the potential for a deeply balancing partnership.",
    tables: [
      {
        title: "Key Synastry Aspects and Their Meaning",
        headers: ["Aspect", "Angle", "Relationship Effect"],
        rows: [
          ["Conjunction", "0°", "Intense fusion — can feel destined or overwhelming"],
          ["Sextile", "60°", "Easy cooperation and mutual support"],
          ["Square", "90°", "Friction and challenge — pushes both to grow"],
          ["Trine", "120°", "Natural harmony, ease, and mutual understanding"],
          ["Opposition", "180°", "Magnetic polarity — attraction and tension"],
        ],
      },
      {
        title: "Most Important Planet Pairs in Synastry",
        headers: ["Planet Pair", "Governs"],
        rows: [
          ["Sun–Moon", "Core compatibility and emotional bond"],
          ["Venus–Mars", "Romantic and sexual attraction"],
          ["Moon–Moon", "Emotional understanding and comfort"],
          ["Saturn–Moon", "Stability, commitment, and restriction"],
          ["Venus–Jupiter", "Joy, generosity, and mutual appreciation"],
          ["Mars–Pluto", "Intensity, power dynamics, transformation"],
        ],
      },
    ],
    tips: [
      "Focus on the Moon and Venus connections first — they matter most for emotional and romantic compatibility",
      "Challenging aspects (squares, oppositions) are not bad — they often create the most growth and passion",
      "A chart with mostly harmonious aspects but no tension can feel comfortable but lack excitement",
      "Synastry works best read alongside a composite chart, which shows the relationship as its own entity",
    ],
    limitations: [
      "Uses birth dates only (no exact time), so Moon signs are approximate — Moon changes sign every 2.5 days",
      "Simplified scoring system — a professional astrologer would weigh aspects more nuancedly",
      "Does not account for house overlays, which require exact birth times and locations",
      "Compatibility scores are indicative only — real relationships depend on communication, values, and effort",
    ],
  },

  "big-three-calculator": {
    whatIs: "Your Big Three in astrology refers to your three most important chart placements: your Sun sign (your core identity and conscious self), your Moon sign (your emotional inner world and instincts), and your Rising sign or Ascendant (how you appear to others and your outer personality). Together, these three signs paint a much richer picture of who you are than your Sun sign alone.",
    whatIsExtra: [
      "Most people know only their Sun sign — the sign the Sun was in on their birthday. But astrologers consider the Moon sign equally or even more important for understanding emotional nature, habits, and what you need to feel safe. The Rising sign, meanwhile, shapes how strangers perceive you before they get to know you.",
      "Understanding your Big Three helps explain why two people with the same Sun sign can be so different. A Scorpio with a Sagittarius Moon and Aquarius Rising will behave very differently from a Scorpio with a Taurus Moon and Cancer Rising — even though both share the same Sun sign.",
    ],
    howFormulaWorks: "The Sun's position is calculated from its annual orbit around the ecliptic (365.25 days per cycle). The Moon's position uses its faster orbital period of approximately 27.3 days. The Rising sign requires your exact birth time to determine which zodiac sign was on the eastern horizon at birth.",
    formulaBreakdown: [
      "Sun sign: determined by the Sun's ecliptic longitude on your birth date (changes sign ~every 30 days)",
      "Moon sign: determined by the Moon's position using its mean anomaly and equation of centre (~27.3-day cycle)",
      "Rising sign: the zodiac sign on the eastern horizon at birth — requires exact time and location",
      "All three use the tropical zodiac, which aligns 0° Aries with the spring equinox",
    ],
    howToUse: [
      "Enter your birth date",
      "Enter your birth time (for the Rising sign — without time, only Sun and Moon are shown)",
      "Enter your birth city",
      "Click Calculate to see all three signs with descriptions",
      "Read the combined personality paragraph that synthesises all three placements",
    ],
    exampleTitle: "Example: Sun Sagittarius, Moon Cancer, Rising Virgo",
    exampleContent: "Sun in Sagittarius: adventurous, philosophical, freedom-loving. Moon in Cancer: deeply emotional, family-oriented, intuitive. Rising in Virgo: presents as analytical, detail-oriented, and helpful. Combined: a warm-hearted explorer who needs emotional security and projects a helpful, organised face to the world.",
    tips: [
      "Your Rising sign is the most time-sensitive — get your exact birth time from your birth certificate",
      "If you don't know your birth time, you can still calculate your Sun and Moon signs accurately",
      "Read all three sign descriptions and notice which resonates most — that's often the dominant influence",
      "Your Sun sign describes who you are becoming; your Moon describes who you already are at your core",
    ],
    limitations: [
      "Moon sign requires an accurate birth date — the Moon changes signs every 2.5 days, so birth dates on cusp days may be approximate",
      "Rising sign is only accurate with the exact birth time and location",
      "The Big Three are a simplified entry point — a full natal chart contains 10+ planetary placements",
    ],
  },

  "venus-sign-calculator": {
    whatIs: "Your Venus Sign is the zodiac sign Venus occupied at the time of your birth. Venus is the planet of love, beauty, pleasure, relationships, and values — and its sign in your chart reveals how you love, what you find attractive, how you express affection, and what you seek in a romantic partner.",
    whatIsExtra: [
      "Venus moves through each zodiac sign in approximately 23–25 days (it has a 225-day orbit), though it occasionally goes retrograde and spends longer in a sign. Because Venus is never more than 48 degrees from the Sun, your Venus sign is always close to your Sun sign — it can only be one or two signs away from your Sun.",
      "In modern astrology, Venus also governs your relationship with money, luxury, art, and beauty. Understanding your Venus sign can reveal not only what you want in a partner, but also how you handle your finances, what aesthetic you're drawn to, and how you prefer to spend your leisure time.",
    ],
    howFormulaWorks: "Venus's position is calculated using its mean longitude at J2000.0 (181.979° at epoch) and its mean daily motion of 1.60213°/day. Corrections are applied for orbital eccentricity using the equation of centre, giving the true ecliptic longitude which is then mapped to the 12 zodiac signs.",
    formulaBreakdown: [
      "Mean longitude L₀ = 181.979° (at J2000.0, Jan 1 2000 at 12:00 TT)",
      "Mean daily motion = 1.60213°/day",
      "Equation of centre correction = 2e × sin(M) + 1.25e² × sin(2M), where M is the mean anomaly",
      "True longitude = L₀ + days × mean motion + equation of centre",
      "Zodiac sign = true longitude divided into 12 × 30° sectors",
    ],
    howToUse: [
      "Enter your birth date",
      "Click Calculate to find your Venus sign",
      "Review your love language, romantic style, and what attracts you",
      "Read your ideal partner description and shadow pattern for deeper self-awareness",
    ],
    exampleTitle: "Example: Born September 5, 1990",
    exampleContent: "Venus is in Virgo → Love language: Acts of Service. Romantic style: attentive, detail-oriented, supportive. Attraction triggers: intelligence, reliability, hygiene, and genuine helpfulness. Shadow: over-critical of self and partner.",
    tables: [
      {
        title: "Venus Signs and Love Styles",
        headers: ["Venus Sign", "Love Language", "Attracted To"],
        rows: [
          ["Aries", "Words of affirmation", "Confidence, directness, spontaneity"],
          ["Taurus", "Physical touch & gifts", "Loyalty, sensuality, stability"],
          ["Gemini", "Words & quality time", "Wit, conversation, mental spark"],
          ["Cancer", "Acts of service & touch", "Nurturing, emotional safety, family"],
          ["Leo", "Quality time & words", "Drama, admiration, loyalty, passion"],
          ["Virgo", "Acts of service", "Intelligence, thoughtfulness, reliability"],
          ["Libra", "Quality time", "Charm, beauty, fairness, partnership"],
          ["Scorpio", "Physical touch", "Intensity, loyalty, depth, transformation"],
          ["Sagittarius", "Quality time", "Adventure, honesty, philosophy, freedom"],
          ["Capricorn", "Acts of service", "Ambition, reliability, status, patience"],
          ["Aquarius", "Quality time", "Uniqueness, intellect, friendship, freedom"],
          ["Pisces", "Physical touch & words", "Romance, empathy, creativity, spirituality"],
        ],
      },
    ],
    tips: [
      "Read your Venus sign alongside your Moon sign for a complete picture of your emotional and romantic needs",
      "Your Venus sign can only be 0–48 degrees from your Sun sign — so check signs close to your own",
      "During Venus retrograde periods, relationship themes connected to your Venus sign often resurface",
      "The house Venus falls in (visible in a full birth chart) shows where you seek love and pleasure in life",
    ],
    limitations: [
      "Uses mean orbital elements — positions are accurate to within ±1 zodiac sign for all dates after 1800",
      "Does not account for Venus retrograde periods, where Venus appears to move backwards and slows significantly",
      "A full interpretation of Venus requires knowing its house placement, which needs your exact birth time",
    ],
  },
};
