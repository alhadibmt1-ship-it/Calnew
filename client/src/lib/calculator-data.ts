...
export const calculatorCategories = [
  ...
  },
  {
    ...
    slug: "business",
    icon: Briefcase,
    description: "Essential business calculators for pricing, profit analysis, invoicing, and accounting.",
    items: [
  ...
  },
  {
    ...
    slug: "education",
    icon: GraduationCap,
    description: "Academic calculators for students to track grades, plan study time, and manage attendance.",
    items: [
