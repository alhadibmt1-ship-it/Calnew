...
export default function SandEstimator() {
  ...
  const calculate = () => {
    ...
    try {
      ...
      const cy = vol / 27; const tons = cy * 1.35;
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto" data-testid="sand-estimator">
      <CardHeader>
        <CardTitle className="text-2xl">Sand Estimator</CardTitle>
        <p className="text-muted-foreground">Estimate sand needed for an area</p>
      </CardHeader>
